...
const mockSponsors = [
  { id: '1', name: 'TechCorp', tier: 'platinum' as const, website: 'https://techcorp.com', isActive: true, sortOrder: 1 },
  { id: '2', name: 'MegaStore', tier: 'gold' as const, website: 'https://megastore.com', isActive: true, sortOrder: 2 },
  { id: '3', name: 'FreshBrands', tier: 'silver' as const, website: 'https://freshbrands.com', isActive: true, sortOrder: 3 },
  { id: '4', name: 'LocalBiz', tier: 'standard' as const, website: 'https://localbiz.com', isActive: false, sortOrder: 4 },
  { id: '5', name: 'GlobalTech', tier: 'platinum' as const, website: 'https://globaltech.com', isActive: true, sortOrder: 5 },
  { id: '6', name: 'QuickShop', tier: 'gold' as const, website: 'https://quickshop.com', isActive: true, sortOrder: 6 },
];
    ...
    <div className="space-y-6">
      ...
      <div className="relative max-w-md">
        ...
        <input type="text" value={search} onChange={(e) => { setSearch(e.target.value); setPage(1); }}
          placeholder="Search sponsors..." className="w-full pl-10 pr-4 py-2 rounded-lg bg-dark-surface-secondary border border-dark-border text-white placeholder-dark-text-tertiary outline-none focus:border-primary-500/50 transition-colors text-sm" />
      </div>
        ...
        {paginated.map((s, i) => (
          <motion.div key={s.id} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.05 }}
            ...
            <div className="flex items-start justify-between mb-3">
              ...
              <span className={`px-2 py-0.5 text-xs font-medium rounded-full ${tierColors[s.tier]}`}>{s.tier}</span>
            </div>
            ...
            <div className="flex items-center justify-between mt-3 pt-3 border-t border-dark-border/50">
              <span className={`text-xs font-medium ${s.isActive ? 'text-success-400' : 'text-danger-400'}`}>
